  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-[#f8fafc] font-sans overflow-x-hidden">
      ...
      <div className="relative z-10 w-full h-full min-h-screen flex flex-col">
        {/* Header */}
        <header className="w-full py-6 px-8 flex items-center justify-between border-b border-white/5 backdrop-blur-md bg-[#0f172a]/80 sticky top-0 z-50">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
            ...
            <button className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-white">
              Sign In
            </button>
          </nav>
        </header>
        ...
        {/* Footer */}
        <footer className="w-full py-6 text-center text-sm text-slate-500 border-t border-white/5 mt-auto">
